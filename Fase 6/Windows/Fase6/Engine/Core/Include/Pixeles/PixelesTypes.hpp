...
#define YELLOW     Color(253, 249,   0, 1.0f)
#define GOLD       Color(255, 203,   0, 1.0f)
#define ORANGE     Color(255, 161,   0, 1.0f)
#define PINK       Color(255, 109, 194, 1.0f)
#define RED        Color(230,  41,  55, 1.0f)
#define MAROON     Color(190,  33,  55, 1.0f)
#define GREEN      Color(  0, 228,  48, 1.0f)
#define LIME       Color(  0, 158,  47, 1.0f)
#define DARKGREEN  Color(  0, 117,  44, 1.0f)
#define SKYBLUE    Color(102, 191, 255, 1.0f)
#define BLUE       Color(  0, 121, 241, 1.0f)
#define DARKBLUE   Color(  0,  82, 172, 1.0f)
#define PURPLE     Color(200, 122, 255, 1.0f)
#define VIOLET     Color(135,  60, 190, 1.0f)
#define DARKPURPLE Color(112,  31, 126, 1.0f)
#define BEIGE      Color(211, 176, 131, 1.0f)
#define BROWN      Color(127, 106,  79, 1.0f)
#define DARKBROWN  Color( 76,  63,  47, 1.0f)
#define WHITE      Color(255, 255, 255, 1.0f)
#define TRANS      Color(  0,   0,   0, 1.0f)
#define BLANK      Color(  0,   0,   0, 1.0f)
...
typedef struct Vec3 {
    ...
    Vec3 operator-=(const Vec3& v) { x -= v.x; y -= v.y; z -= v.z; return *this; }
    Vec3& operator=(const glm::vec3& v) { x = v.x; y = v.y; z = v.z; return *this; }
} Vec3;
...
typedef struct Vec4 {
    ...
    Vec4 operator-=(const Vec4& v) { x -= v.x; y -= v.y; z -= v.z; w -= v.w; return *this; }
    Vec4& operator=(const glm::vec4& v) { x = v.x; y = v.y; z = v.z; w = v.w; return *this; }
} Vec4;