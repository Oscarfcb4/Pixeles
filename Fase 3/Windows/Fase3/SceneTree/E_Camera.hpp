...
struct E_Camera: virtual public E_Entity{
    ...
    private:
        ...
        void updateCameraVectors(){
            ...
            // Normalizamos el vector front para que tenga longitud 1 y guardamos sus componentes,
            // esto es necesario porque el vector front debe ser un vector unitario para usarse con la camara
